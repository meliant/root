...
\hypersetup{
	pdftitle={Helena},
	pdfauthor={Alex I. N. Klein},   % pen name only — never the real name
...
\setotherlanguages{french,german,portuguese}% hebrew is declared separately at the very end of the preamble -- see the note there (bidi load order)
...
\begin{document}
	...
	\begin{center}
		...
		{\Huge\bfseries Helena}
		
		\vspace{1in}
		
		{\Large Alex I.~N. Klein}
	...
	\begin{center}
		...
		Copyright \copyright\ 2026 Alex I.~N. Klein
...
\begin{center}
	\begin{minipage}{0.75\textwidth}
		\centering
		Italicized dialogue in this novella is spoken in French, rendered into English.
		
		\bigskip
		
		Roman dialogue is spoken in English.
		
		\bigskip
		
		A row of asterisks marks the start of a shooting; a row of diamonds, its end. Other section breaks are marked --- § ---
